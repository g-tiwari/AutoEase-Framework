...
public class WaitSteps {
	...
	WebDriverGenerator wd=new WebDriverGenerator();
	...
	public void I_wait_for_presence_of_element(String params1) throws Throwable {
		WebDriverGenerator.getWaitObject().until(ExpectedConditions.presenceOfElementLocated(wd.getIdentifierAt(params1)));
	//throw new PendingException();
